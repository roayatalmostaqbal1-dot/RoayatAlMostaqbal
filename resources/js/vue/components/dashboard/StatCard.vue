        ...
        <div class="flex items-start justify-between">
            <div>
                ...
                <div class="flex items-center gap-1">
                    <svg v-if="trendUp" class="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
...
const IconMessages = {
    render: () => h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
        h('path', { d: 'M20 4H4a2 2 0 00-2 2v12a2 2 0 002 2h14c.55 0 1-.45 1-1V6c0-.55-.45-1-1-1zm0 14H4V8l8 5l8-5v1' })
    ])
};
