<template>
    <div
        ...
        <TwoFactorVerification v-if="show2FAModal" :user-id="twoFactorUserId" @verified="handle2FAVerified"
        ...
        <div class="w-full max-w-md">
            ...
            <Card class="mb-6">
                <form @submit.prevent="handleLogin">
                    <!-- Error Alert -->
                    <div v-if="authStore.errors"
                        class="mb-4 p-4  bg-red-500 bg-opacity-20 border border-red-500 rounded-lg">
                        <p class="text-white text-sm">{{ authStore.errors }}</p>
                    </div>
                    ...
                    <!-- Password Input -->
                    <div class="mb-6">
                        <Input v-model="form.password" type="password" label="Password" placeholder="••••••••"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <router-link to="/forgot-password"
                            class="text-sm text-[#27e9b5] hover:text-white transition-colors">
                            Forgot password?
                        </router-link>
                    </div>

                    <!-- Login Button -->
                    <Button type="submit" variant="primary" size="lg" class="w-full mb-4"
